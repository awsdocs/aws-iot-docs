# Install the Device SDK and run the `shadow.py` sample application for Device Shadows<a name="lightbulb-shadow-application"></a>
...
## Review the shadow\.py Device SDK sample app<a name="review-shadow-sample-code"></a>
