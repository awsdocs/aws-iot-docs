# Troubleshooting AWS IoT identity and access<a name="security_iam_troubleshoot"></a>
...
+ [I'm an administrator and want to allow others to access AWS IoT](#security_iam_troubleshoot-admin-delegate)
...
## I am not authorized to perform an action in AWS IoT<a name="security_iam_troubleshoot-no-permissions"></a>
...
```
User: arn:aws:iam::123456789012:user/mateojackson is not authorized to perform: iot:DescribeThing
...
```
User: arn:aws:iam::123456789012:user/mateojackson is not authorized to perform: iotdeviceadvisor:GetSuiteDefinition
...
## I'm an administrator and want to allow others to access AWS IoT<a name="security_iam_troubleshoot-admin-delegate"></a>
...
## I want to allow people outside of my AWS account to access my AWS IoT resources<a name="security_iam_troubleshoot-cross-account-access"></a>
