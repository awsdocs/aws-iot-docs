...
| --- | --- | --- | 
|  $aws/things/*thingName*/defender/metrics/  |  Publish  |  Device Defender agents publish metrics to this topic\. For more information, see [Sending metrics from devices](device-defender-detect.md#DetectMetricsMessages)\.   | 
