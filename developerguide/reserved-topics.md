...
|  $aws/things/*thingName*/jobs/get/rejected  |  Subscribe, Receive  |  Devices subscribe to this topic to receive a response when a `GetPendingJobExecutions` request is rejected\. For more information, see [Jobs device MQTT and HTTPS APIs](jobs-api.md#jobs-mqtt-api)\.  | 
...
|  $aws/things/*thingName*/jobs/start\-next/rejected  |  Subscribe, Receive  |  Devices subscribe to this topic to receive a response when a `StartNextPendingJobExecution` request is rejected\. For more information, see [Jobs device MQTT and HTTPS APIs](jobs-api.md#jobs-mqtt-api)\.  | 
...
|  $aws/things/*thingName*/jobs/*jobId*/get/rejected  |  Subscribe, Receive  |  Devices subscribe to this topic to receive a response when a `DescribeJobExecution` request is rejected\. For more information, see [Jobs device MQTT and HTTPS APIs](jobs-api.md#jobs-mqtt-api)\.  | 
...
|  $aws/things/*thingName*/jobs/notify\-next  |  Subscribe  |  Devices subscribe to this topic to receive notifications when the next pending job execution for the thing is changed\. For more information, see [Jobs device MQTT and HTTPS APIs](jobs-api.md#jobs-mqtt-api)\.  | 
