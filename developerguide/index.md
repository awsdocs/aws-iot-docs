...
+ [Getting Started with](iot-gs.md)
...
+ [Alexa Voice Service Integration for AWS IoT](avs-integration-aws-iot.md)
   + [Getting Started with Alexa Voice Service Integration for AWS IoT on an NXP Device](avs-integration-aws-iot-gs-nxp.md)
